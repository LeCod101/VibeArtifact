 ...
 * 模板选择器组件
 *
 * 展示可用的项目模板卡片网格，点击后弹出确认对话框输入项目名称，
 * 确认后调用 POST /projects/from-template 创建项目并跳转。
 */
"use client";
    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {templates.map((template) => (
          <Card
            key={template.id}
            className="p-5 cursor-pointer hover:shadow-md transition-shadow border hover:border-primary/50"
